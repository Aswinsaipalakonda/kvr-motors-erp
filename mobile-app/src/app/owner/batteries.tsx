...
export default function OwnerBatteries() {
  ...
  const [batteryLocation, setBatteryLocation] = useState<{ id: number; name: string } | null>(null);
  ...
  const loadAllData = async (pullToRefresh = false) => {
    try {
      ...
      const [battRes, branchesRes, locationsRes] = await Promise.all([
        api.get('/batteries/'),
        api.get('/branches/'),
  ...
  const handleBatteryDelete = (b: Battery) => {
    Alert.alert(
      'Remove Battery Pack',
      `Are you sure you want to permanently delete battery pack "${b.serial_number}" from local databases?`,
      [
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={[styles.darkHeader, { paddingTop: insets.top + 12 }]}>
          <View style={styles.headerRow}>
            ...
            <View style={styles.badgeWrapper}>
              ...
              <ThemedText style={styles.badgeText}>BATTERY STOCK REGISTRY</ThemedText>
            </View>
          </View>

          <View style={styles.titleWrapper}>
            <ThemedText style={styles.mainTitle}>Battery Stock</ThemedText>
            <ThemedText style={styles.accentTitle}>Warehouse Ledger.</ThemedText>
          </View>
        ...
        {isLoading ? (
          <View style={styles.loaderContainer}>
            ...
            <ThemedText style={styles.loaderText}>Syncing battery databases...</ThemedText>
          </View>
        ) : (
          <ScrollView
                  ...
                  return (
                    <View key={b.id} style={styles.itemCard}>
                      ...
                      <View style={styles.detailsGrid}>
                        ...
                        <View style={styles.gridItem}>
                          <ThemedText style={styles.gridLabel}>WAREHOUSE LOCATION</ThemedText>
                      ...
                      <View style={styles.cardActions}>
                        <Pressable onPress={() => openEditBattery(b)} style={[styles.actionBtn, styles.editBtn]}>
                          ...
                          <ThemedText style={[styles.actionBtnText, { color: '#2563eb' }]}>Edit Storage</ThemedText>
                        </Pressable>
              ...
              <ScrollView style={styles.modalFormScroll} contentContainerStyle={styles.modalFormContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.field}>
                  ...
                  <Pressable onPress={() => setIsLocationPickerOpen(true)} style={styles.pickerSelector}>
                    <ThemedText style={styles.pickerSelectorText}>{batteryLocation ? batteryLocation.name : 'Select yard/godown...'}</ThemedText>
                ...
                <Pressable onPress={handleBatterySubmit} disabled={isSubmitting} style={styles.submitBtn}>
                  {isSubmitting ? <ActivityIndicator size="small" color="#ffffff" /> : (
                    <>
                      ...
                      <ThemedText style={styles.submitBtnText}>Transmit to Storage Ledger</ThemedText>
                    </>
                  )}
                </Pressable>
              </ScrollView>
